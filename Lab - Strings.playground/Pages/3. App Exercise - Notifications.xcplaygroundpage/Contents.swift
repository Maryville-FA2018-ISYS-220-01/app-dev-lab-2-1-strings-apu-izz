...
let congratulations = "congratulations, \(fullName)! You beat your previous daily high score of \(previousBest) steps walking \(newBest) steps yesterday!"
